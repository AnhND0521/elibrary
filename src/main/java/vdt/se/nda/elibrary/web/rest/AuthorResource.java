...
import vdt.se.nda.elibrary.repository.AuthorRepository;
import vdt.se.nda.elibrary.service.AuthorService;
import vdt.se.nda.elibrary.service.dto.AuthorDTO;
import vdt.se.nda.elibrary.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link vdt.se.nda.elibrary.domain.Author}.
 */
@RestController
@RequestMapping("/api")
