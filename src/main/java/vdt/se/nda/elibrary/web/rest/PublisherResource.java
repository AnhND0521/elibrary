...
import vdt.se.nda.elibrary.repository.PublisherRepository;
import vdt.se.nda.elibrary.service.PublisherService;
import vdt.se.nda.elibrary.service.dto.PublisherDTO;
import vdt.se.nda.elibrary.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link vdt.se.nda.elibrary.domain.Publisher}.
 */
@RestController
@RequestMapping("/api")
