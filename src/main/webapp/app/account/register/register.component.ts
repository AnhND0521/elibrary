...
export class RegisterComponent implements AfterViewInit {
  ...
  register(): void {
    ...
    if (password !== confirmPassword) {
      ...
      const { login, email, firstName, surname } = this.registerForm.getRawValue();
      this.registerService
        .save({ login, firstName, lastName: surname, email, password, langKey: this.translateService.currentLang })
