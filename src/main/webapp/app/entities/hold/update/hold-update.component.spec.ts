...
describe('Hold Management Update Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [HoldUpdateComponent],
      providers: [
        FormBuilder,
        {
  ...
  describe('ngOnInit', () => {
    it('Should call BookCopy query and add missing value', () => {
      ...
      const copy: IBookCopy = { id: 19996 };
      hold.copy = copy;

      const bookCopyCollection: IBookCopy[] = [{ id: 66867 }];
    ...
    it('Should call PatronAccount query and add missing value', () => {
      const hold: IHold = { id: 456 };
      const patron: IPatronAccount = { cardNumber: '7ca4b8f0-6' };
      hold.patron = patron;

      const patronAccountCollection: IPatronAccount[] = [{ cardNumber: 'd28a3cee-a' }];
    ...
    it('Should update editForm', () => {
      const hold: IHold = { id: 456 };
      const copy: IBookCopy = { id: 93030 };
      hold.copy = copy;
      const patron: IPatronAccount = { cardNumber: 'df0ae83c-a' };
      hold.patron = patron;
